<template>
    <div>
        ...
        <!--            class="mx-auto"-->
        <!--        >-->
        <!--        <v-data-table :headers="headers" :hide-default-footer="true" :items="tokens"-->
        <!--        >-->
        ...
        <!--                                <h5 class="mb-0 align-self-center">Personal Access Tokens</h5>-->
        ...
        <!--                                    <span>Create New Token</span></v-btn-->
        <!--                                >-->
        <!--                            </div>-->
        <!--                        </v-col>-->
        <!--                        <v-spacer></v-spacer>-->
        ...
        <!--                    <v-btn color="red" icon x-small @click="revoke(item)">-->
        ...
        <div>
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <!-- Personal Access Tokens -->
                    <table v-if="tokens.length > 0" class="table table-borderless mb-0">
                        <thead>
                        <tr>
                            <th>Name</th>
                            <th></th>
        ...
        getTokens() {
            axios.get('/oauth/personal-access-tokens', {
                headers: {
                    ...
                    Authorization: "Bearer " + this.$store.getters.GET_ACCESS_TOKEN
                }
            })
                .then(response => {
